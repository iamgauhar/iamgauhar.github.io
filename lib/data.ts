...
export const GENERAL_INFO = {
    ...
    emailBody: 'Hi Mohammad, I am reaching out to you because...',
...
export const SOCIAL_LINKS = [
    { name: 'github', url: 'https://github.com/iamgauhar' },
    { name: 'linkedin', url: 'https://www.linkedin.com/in/iamgauhar' },
    { name: 'X / Twitter', url: 'https://x.com/iamgauhar_in' },
    { name: 'Instagram', url: 'https://www.instagram.com/iamgauhar.in' },
];
...
export const MY_EDUCATION = [
    {
        place: 'Masai School, Banglore',
        major: 'Web Development',
        duration: 'Jul 2022 - Jul 2023',
    },
    {
        place: 'Makhanlal Chaturvedi National University, Bhopal',
